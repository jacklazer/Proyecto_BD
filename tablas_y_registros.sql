...
-- Usuario
INSERT INTO usuario (codigo_usuario, nombre_usuario, direccion_usuario, telefono_usuario, e_mail_usuario)
VALUES
	('U00001', 'Juan Pérez', 'Calle 123, Ciudad', '1234567890', 'juan@example.com'),
	('U00002', 'María López', 'Avenida 456, Ciudad', '9876543210', 'maria@example.com'),
	('U00003', 'Pedro Rodríguez', 'Plaza 789, Ciudad', '5678901234', 'pedro@example.com'),
	('U00004', 'Ana Sánchez', 'Carrera 321, Ciudad', '4321098765', 'ana@example.com'),
	('U00005', 'Luis Romero', 'Camino 654, Ciudad', '9012345678', 'luis@example.com'),
	('U00006', 'Laura González', 'Paseo 987, Ciudad', '3456789012', 'laura@example.com'),
	('U00007', 'Carlos Vargas', 'Callejón 234, Ciudad', '6789012345', 'carlos@example.com'),
	('U00008', 'Sofía Torres', 'Avenida 567, Ciudad', '1234509876', 'sofia@example.com'),
	('U00009', 'Javier Herrera', 'Plaza 890, Ciudad', '9876512340', 'javier@example.com'),
	('U00010', 'Paula Rojas', 'Carrera 432, Ciudad', '5678904321', 'paula@example.com'),
	('U00011', 'Miguel Gómez', 'Calle 456, Ciudad', '1234567890', 'miguel@example.com'),
	('U00012', 'Andrea López', 'Avenida 789, Ciudad', '9876543210', 'andrea@example.com'),
	('U00013', 'David Martínez', 'Plaza 123, Ciudad', '5678901234', 'david@example.com'),
	('U00014', 'Carolina Sánchez', 'Carrera 654, Ciudad', '4321098765', 'carolina@example.com'),
	('U00015', 'Gabriel Romero', 'Camino 987, Ciudad', '9012345678', 'gabriel@example.com'),
	('U00016', 'Valeria González', 'Paseo 234, Ciudad', '3456789012', 'valeria@example.com'),
	('U00017', 'Luisa Vargas', 'Callejón 567, Ciudad', '6789012345', 'luisa@example.com'),
	('U00018', 'Daniel Torres', 'Avenida 890, Ciudad', '1234509876', 'daniel@example.com'),
	('U00019', 'Camila Herrera', 'Plaza 432, Ciudad', '9876512340', 'camila@example.com'),
	('U00020', 'Roberto Rojas', 'Carrera 789, Ciudad', '5678904321', 'roberto@example.com');
...
-- Empleado
INSERT INTO empleado (identificacion_empleado, nombre_empleado, cargo_empleado)
VALUES
	('1008965843', 'Andres Zuluaga', 'Administrador'),
	('3659863', 'Juan Vargas', 'Responsable de Sala'),
	('1003985632', 'Felipe Gutierrez', 'Bibliotecario'),
	('11589663', 'Jhon Alvarez', 'Secretario'),
	('8596325', 'Camilo Vargas', 'Encargado de Prestamos'),
	('10059862', 'Sara Medina', 'Encargado de Prestamos'),
	('1004563144', 'Abel Angels', 'Responsable de Sala'),
	('38596325', 'William Shall', 'Administrador'),
	('1005981683', 'Catalina Bolanos', 'Encargado de Prestamos'),
	('11801779', 'Alma Smith', 'Responsable de Sala');
